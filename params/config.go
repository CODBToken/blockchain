...
var (
	MainnetGenesisHash = common.HexToHash("0x146addb88eb7236ed07ca6fcdebaf9aed48498fa42d086455d102ad7cac94176")
	TestnetGenesisHash = common.HexToHash("")
	DevnetGenesisHash  = common.HexToHash("")
)
...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		ChiefBaseAddress: common.HexToAddress("0x8ef8afd1bfcbd5b8d30a0c0a7f17b536f0610584"),

		PocAddress: common.HexToAddress("0xfda6a6927deaf43dea8120bbdbeb5e0c151b9723"),

		Chief100Block:   big.NewInt(15),
		Chief100Address: common.HexToAddress("0x3544cedc7fe6b48c3c81973c4460eb0db62e2851"),

		Anmap001Block:   big.NewInt(0),
		Anmap001Address: common.HexToAddress("0x"),

		UIP001Block: big.NewInt(50),
		UIP002Block: big.NewInt(50),
...
type ChainConfig struct {
	...
	// https://github.com/yunhailanuxgk/go-jinbao/wiki/%5BChinese%5D-v1.0.0-Standard
