...
import (
	...
	"github.com/yunhailanuxgk/go-jinbao/internal/build"
)
...
public class AndroidTest extends InstrumentationTestCase {
	...
	// signatures too. Regression test for JINBAO issue #14599.
...
func TestAndroid(t *testing.T) {
	...
	gobind := exec.Command("gomobile", "bind", "-javapkg", "org.ethereum", "github.com/yunhailanuxgk/go-jinbao/mobile")
