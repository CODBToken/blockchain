...
// This file is part of JINBAO.
//
// JINBAO is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// JINBAO is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
// GNU General Public License for more details.
//
// You should have received a copy of the GNU General Public License
// along with JINBAO. If not, see <http://www.gnu.org/licenses/>.

// Package utils contains internal helper functions for JINBAO commands.
package utils
...
import (
	...
	"github.com/yunhailanuxgk/go-jinbao/consensus/clique"
	...
	"github.com/yunhailanuxgk/go-jinbao/dashboard"
	"github.com/yunhailanuxgk/go-jinbao/eth"
	"github.com/yunhailanuxgk/go-jinbao/eth/downloader"
	"github.com/yunhailanuxgk/go-jinbao/eth/gasprice"
	"github.com/yunhailanuxgk/go-jinbao/ethdb"
	"github.com/yunhailanuxgk/go-jinbao/ethstats"
	"github.com/yunhailanuxgk/go-jinbao/les"
	"github.com/yunhailanuxgk/go-jinbao/log"
	"github.com/yunhailanuxgk/go-jinbao/metrics"
	"github.com/yunhailanuxgk/go-jinbao/node"
	...
	whisper "github.com/yunhailanuxgk/go-jinbao/whisper/whisperv5"
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `jinbao account list`)")
	log.Warn("-------------------------------------------------------------------")
...
// new format.
//
// e.g. jinbao account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// jinbao --keystore /tmp/mykeystore --lightkdf account new
//
